<?php
/**
 * The single arki on tv template file.
 * 
 * @package Luisa
 * @since Luisa 1.0
 */
...
<section class="container single-portfolio">
	<div class="col-md-12">
		...
		echo "test";
			$images = rwmb_meta( 'rw_elupload','size=large' ); // Since 4.8.0
			$images = rwmb_meta( 'rw_elupload', 'type=plupload_image&size=large' ); // Prior to 4.8.0
		?>
   		<div class="row">
